...
const PredictiveDialer = () => {
	const { data: solution } = useSolutionBySlug('predictive-dialer');

	const fallback: Partial<Solution> = {
		title: 'Predictive Dialer Solution',
		description: 'AI-powered dialing for maximum efficiency.',
		longDescription: [
			{ _type: 'block', children: [{ _type: 'span', text: 'Leverage machine learning to optimize call connect rates and agent utilization.' }] }
		],
		features: [
			'AI Call Scheduling',
			'Abandon Rate Control',
			'Real-time Analytics',
			'CRM Integration',
		...
		specifications: [
			{ _type: 'block', children: [{ _type: 'span', text: 'AI-driven algorithms, scalable, TCPA compliant.' }] }
		],
		pricing: 'Starting at $59/user/month',
		pricingModel: 'per-user',
		testimonials: [
			'“Our connect rates improved dramatically.”',
			'“Predictive logic saves us hours daily.”',
		],
		relatedSolutions: [
		...
		<div>
			...
			<section className="section-padding bg-gradient-primary">
				<div className="container-custom text-center">
					<h2 className="text-2xl md:text-3xl font-bold text-white mb-6">Ready to predict your success?</h2>
